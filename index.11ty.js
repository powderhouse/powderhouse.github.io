...
exports.render = function (data) {
	let reviewSections = [
		...
		{slug: "projects-and-prototypes", title: "Projects & prototypes", header: true},
		...
		{slug: "meditations-on-our-mission", title: "Meditations on our mission", header: true},
	];

	let reviewSectionsHTML = reviewSections.map(s => `
		<section id='${s.slug}'>
