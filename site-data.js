...
const mediaQueries = {
  'mobile': `(max-width: ${BREAKPOINTS.tabletMin / 17}rem)`,
  'tabletAndUp': `(min-width: ${BREAKPOINTS.tabletMin / 17}rem)`,
  'laptopAndUp': `(min-width: ${BREAKPOINTS.laptopMin / 17}rem)`,
  'desktopAndUp': `(min-width: ${BREAKPOINTS.desktopMin / 17}rem)`,
}
