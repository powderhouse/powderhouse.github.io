  ...
  long: {
    thick: {
      shortText: (className = "--off-black", height = "100%", width = "100%") => (
        <svg
          className={"arrowSVG " + className.substring(0,2)=="--" ? className.slice(2) : className}
    ...
    short: {
      1: (className = "--off-black") => (
        <svg
          ...
          strokeWidth="2.5"
          preserveAspectRatio="none"
          className={className.substring(0,2)=="--" ? className.slice(2) : className}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeMiterlimit="10"
          strokeDasharray=""
        >
          <path vectorEffect="non-scaling-stroke" d="M 2.194 28.897 L 2.194 2.208 L 53.346 2.208 L 63.046 15.426 L 53.346 28.897 Z"></path>
          <path vectorEffect="non-scaling-stroke" d="M 51.5 3 L 43 27.5 L 29 3 L 23.5 27.5 L 19.5 3 L 13.5 27.5 L 3.5 3"></path>
        </svg>
      ),
      2: (className = "--off-black") => (
        <svg
          ...
          fill="transparent"
          strokeWidth="2.5"
          class={className.substring(0,2)=="--" ? className.slice(2) : className}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeMiterlimit="10"
          strokeDasharray=""
        >
          <path 
            vectorEffect="non-scaling-stroke"  d="M 2 29 L 2 2 L 59.5 2 L 69 15.5 L 59.5 29 Z"></path>
          <path 
            vectorEffect="non-scaling-stroke"  d="M 62.5 7 L 51.5 27.5 L 41.5 3 L 34 29 L 30.5 2 L 14.5 29 L 4 3"></path>
        </svg>
      ),
      3: (className = "--off-black") => (
        ...
        >
          <path 
            vectorEffect="non-scaling-stroke"  d="M 2.194 28.897 L 2.194 2.208 L 53.346 2.208 L 63.046 15.426 L 53.346 28.897 Z"></path>
          <path 
            vectorEffect="non-scaling-stroke"  d="M 58 10 L 43 27.5 L 38.5 3 L 23.5 27.5 L 32 2 L 13.5 27.5 L 10.5 3"></path>
        </svg>
      ),
    },
    long: {
      1: (className = "--off-black") => (
        ...
        >
          <path 
            vectorEffect="non-scaling-stroke"  d="M 2.194 28.897 L 2.194 2.208 L 90.5 2 L 100 15.5 L 90.5 29 Z"></path>
          <path 
            vectorEffect="non-scaling-stroke"  d="M 88 3 L 83 29 L 61 2 L 55 27.5 L 50.5 3 L 42 27.5 L 28 3 L 22.5 27.5 L 18.5 3 L 12.5 27.5 L 2.5 3"></path>
        </svg>
      ),
    },
  },
...
let logoSVG = (className = "--off-black") => (
  ...
  >
    <path 
      vectorEffect="non-scaling-stroke"  d="M 535.468018 1.538025 L 531.73999 -0.025024 L 0.728996 320.594971 L 0.728996 653.598999 L 1391.779053 653.598999 L 1391.779053 356.02301 Z M 16.760002 339.992004 L 174.619995 433.011963 L 16.760002 623.500977 Z M 999.43103 210.942993 L 1364.847046 362.234985 L 1205.504028 437.700989 Z M 1190.435059 444.875 L 798.848999 630.354004 L 730.919983 465.716003 L 978.552002 211.744019 Z M 724.267029 449.604004 L 548.732971 24.382019 L 969.134033 198.398987 Z M 712.244019 462.109009 L 545.606995 632.999023 L 199.147003 428.604004 L 532.260986 26.505981 Z M 184.959991 420.507996 L 23.813004 325.523987 L 504.047974 35.442993 Z M 188.606995 441.268005 L 521.84198 637.64801 L 25.817001 637.64801 Z M 718.697021 478.219971 L 784.502014 637.728027 L 563.159973 637.728027 Z M 1201.656006 457.259033 L 1365.649048 637.607971 L 820.611023 637.607971 Z M 1216.805054 450.084961 L 1375.748047 374.780029 L 1375.748047 625.023987 Z" />
  </svg>
);
