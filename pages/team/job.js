  ...
  return (
    <PageContainer css={baseGrid}>
        ...
        <PageSplash bgColor='red' color='off-white'>
          ...
          <PageTableOfContents>
            {jobCards.data[jobNum].attributes.PageSections.map(n => <PageTOCListItem key={n.id}><PageTOCLink href={"#"+n.SectionHeader.replace(/\s+/g, '-').toLowerCase()}>{n.SectionHeader}</PageTOCLink></PageTOCListItem>)}
          </PageTableOfContents>
        </PageSplash>
        <PageIntro>
            {jobCards.data[jobNum].attributes.JobSubtitle}
        </PageIntro>
