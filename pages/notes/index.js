...
// function NotesPage({ notesPage, notes }) {
//   let accentColor = "--yellow";

//   // let sortedNotesCards = newsCards.data
//   //   .sort((a, b) => {
...
// let NotesItemContainer = styled.div`
//   grid-column: 1 / -1;
...
// function NotesItem({ date, type, title, excerpt, links }) {
//   return (
...
//   let notesPage = await fetchAPI("/notes?populate=*");
//   // TODO: Ideally would "get all" rather than "get 100"
//   let notesCards = await fetchAPI(
